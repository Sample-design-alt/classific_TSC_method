...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset',type=str, default='Adiac',help='The dataset name')
    parser.add_argument('--run_name', type=str,default='ucr_output', help='The folder name used to save model, output and evaluation metrics. This can be set to any word')
